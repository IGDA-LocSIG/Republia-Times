package org.flixel
{
	...
	public class FlxText extends FlxSprite
	{
		 ...
		 */
		public function setFormat(Font:String = null, Size:Number = 8, Color:uint = 0xffffff, Alignment:String = null, ShadowColor:uint = 0, ls:int = 0, isBold:Boolean = false):FlxText
		{
			if(Font == null)
				Font = "";
		 ...
		 */
		public function set flxTextWidth(val:Number):void
		{
		...
		{
			return _textField.textWidth as Number;
		}
		...
		override protected function calcFrame():void
		{
			...
			if((_textField != null) && (_textField.text != null) && (_textField.text.length > 0))
			{
				...
				if(_shadow > 0)
				{
					...
					_pixels.draw(_textField,_matrix,_colorTransform,null,null,true);
					_matrix.translate(-1,-1);
